---
title: "github pages 和 Hugo 搭建个人博客"
date: 2024-01-29
categories: ["技术"]
tags: []
---
...
![create_resp](/images/tech/create_resp.png)

### 配置 pages

![create_resp](/images/tech/resp_page.png)
...
图片放在 `` static/images `` 目录下，可以这样使用： `` /images/my.png `` 。
